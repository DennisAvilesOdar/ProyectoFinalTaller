<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="gradoestudio.aspx.cs" Inherits="ColegioMocupe.View.Estudio.gradoestudio" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../app/Estudio/gradoestudio.js"></script>
</asp:Content>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-header-danger">
                        <h4 class="card-title">Grado de Estudio</h4>
                        <p class="category">Opciones de Grado de Estudio</p>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="txtGrado" class="col-sm-2 col-form-label">Nombre del Grado de Estudio</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="txtGrado">
                            </div>
                        ...
                        <div class="table-responsive">
                            <table id="tblRegistro" class="table">
                                <thead>
                                    <tr>
                                        <th data-field="ID_GRADO_ESTUDIO" data-halign="center" data-align="center">Cod de Grado de Estudio</th>
                                        <th data-field="ESP_NOMBRE" data-halign="center" data-align="center">Nombre del grado de estudio</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tituloModal">Editar Grado Estudio</h5>
