<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="grado.aspx.cs" Inherits="ColegioMocupe.View.Estudio.grado" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../app/Estudio/grado.js"></script>
</asp:Content>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header card-header-danger">
                        ...
                        <p class="category">Opciones de Grado</p>
                    </div>
                    <div class="card-body">
                        <div class="form-group row">
                            <label for="txtGrado" class="col-sm-2 col-form-label">Nombre del Grado</label>
                            <div class="col-sm-8">
                        ...
                        <div class="table-responsive">
                            <table id="tblRegistro" class="table">
                                <thead>
                                    <tr>
                                        <th data-field="ID_GRADO" data-halign="center" data-align="center">Cod de Grado</th>
                                        <th data-field="NUM_GRADO" data-halign="center" data-align="center">Nombre del grado</th>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tituloModal">Editar Grado</h5>
